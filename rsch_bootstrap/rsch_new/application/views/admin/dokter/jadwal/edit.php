...
<form action="<?php echo base_url('admin/jadwal/edit/' . $jadwal['jadwal_id']) ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <a class="btn btn-danger" href="<?php echo base_url('admin/jadwal/'); ?>">Cancel</a>
        </div>
    </div>
