...
<form action="<?php echo base_url('admin/dashboard/logo') ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        <label>Logo Sebelumnya:</label><br>
        <img src="<?php echo base_url('assets/upload/image/thumbs/' . $site['logo']); ?>">
        &nbsp; &nbsp; <a href="<?php echo base_url('assets/upload/image/thumbs/' . $site['logo']); ?>">Lihat Gambar</a>
    </div>
